...
RSpec.describe SharesController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested share as @share" do
      share = Share.create! valid_attributes
      get :show, params: {id: share.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested share as @share" do
      share = Share.create! valid_attributes
      get :edit, params: {id: share.to_param}, session: valid_session
      expect(assigns(:share)).to eq(share)
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested share" do
        share = Share.create! valid_attributes
        put :update, params: {id: share.to_param, share: new_attributes}, session: valid_session
        share.reload
      ...
      it "assigns the requested share as @share" do
        share = Share.create! valid_attributes
        put :update, params: {id: share.to_param, share: valid_attributes}, session: valid_session
        expect(assigns(:share)).to eq(share)
      end
    ...
    context "with invalid params" do
      it "assigns the share as @share" do
        share = Share.create! valid_attributes
        put :update, params: {id: share.to_param, share: invalid_attributes}, session: valid_session
        expect(assigns(:share)).to eq(share)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested share" do
      share = Share.create! valid_attributes
      expect {
        delete :destroy, params: {id: share.to_param}, session: valid_session
      }.to change(Share, :count).by(-1)
    end
