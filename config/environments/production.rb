Rails.application.configure do
  ...
  # Use a real queuing backend for Active Job (and separate queues per environment)
    ...
    config.active_job.queue_name_prefix = "cxl_#{Rails.env}"
  ...
  if Setting.mailer_provider == 'postmark'
    config.action_mailer.postmark_settings = Setting.mailer_options.deep_symbolize_keys.delete_if{|k,v|k!=:api_token}
  else
