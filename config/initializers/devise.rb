...
Devise.setup do |config|
  ...
  config.omniauth :wechat, Setting.wechat_id, Setting.wechat_secret
  config.omniauth :wechat_qr, Setting.wechat_qr_id, Setting.wechat_qr_secret
  #config.omniauth :weixin, Setting.mp_weixin_id, Setting.mp_weixin_secret
