...
ActiveRecord::Schema.define(version: 20170808083702) do
  ...
  create_table "academia", force: :cascade do |t|
    ...
    t.index ["name"], name: "index_academia_on_name", using: :btree
  end
  ...
  create_table "authorizations", force: :cascade do |t|
    ...
    t.string   "openid"
    t.index ["openid"], name: "index_authorizations_on_openid", using: :btree
  ...
  create_table "friend_requests", force: :cascade do |t|
    ...
    t.index ["access_token", "expires_at"], name: "index_friend_requests_on_access_token_and_expires_at", using: :btree
    t.index ["access_token"], name: "index_friend_requests_on_access_token", using: :btree
    t.index ["expires_at"], name: "index_friend_requests_on_expires_at", using: :btree
  ...
  create_table "friendships", force: :cascade do |t|
    ...
    t.index ["friend_request_id"], name: "index_friendships_on_friend_request_id", using: :btree
  ...
  create_table "keywords", force: :cascade do |t|
    ...
    t.datetime "updated_at",              null: false
    t.integer  "user_id"
    t.index ["name"], name: "index_keywords_on_name", using: :btree
    t.index ["user_id"], name: "index_keywords_on_user_id", using: :btree
    t.index ["using_count"], name: "index_keywords_on_using_count", using: :btree
  end
  ...
  create_table "nodes", force: :cascade do |t|
    ...
    t.string   "tag"
    t.integer  "audit",        default: 0,     null: false
    t.integer  "user_id"
  ...
  create_table "organisations", force: :cascade do |t|
    ...
    t.datetime "created_at",           null: false
    t.datetime "updated_at",           null: false
    t.index ["name"], name: "index_organisations_on_name", using: :btree
    t.index ["ticker"], name: "index_organisations_on_ticker", using: :btree
  end
  ...
  create_table "scrapes", force: :cascade do |t|
    ...
    t.datetime "created_at",              null: false
    t.datetime "updated_at",              null: false
    t.integer  "news_status", default: 0
  end
  ...
  create_table "shares", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["friend_id"], name: "index_shares_on_friend_id", using: :btree
  ...
  create_table "subscriptions", force: :cascade do |t|
    ...
    t.datetime "created_at",               null: false
    t.datetime "updated_at",               null: false
    t.integer  "apply_status", default: 2
    t.integer  "invite_id"
    t.index ["invite_id"], name: "index_subscriptions_on_invite_id", using: :btree
  end
  ...
  create_table "topics", force: :cascade do |t|
    ...
    t.index ["recommendation"], name: "index_topics_on_recommendation", using: :btree
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index ["interest"], name: "index_users_on_interest", using: :btree
